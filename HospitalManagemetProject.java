...
class staff
{
    ...
    void staff_info()
    {
        System.out.println(sid + "\t" + sname + "\t" + sex + "\t" + age + "\t" + salary + "\t");
    }
}
...
class doctor
{
    ...
    void doctor_info()
    {
        System.out.println(did + "\t" + dname + "\t" + specilist + " \t " + age + "\t" + appoint + "\t" + doc_qual + "\t" + droom + "\t");
    }
}
class patient
{
...
public class HospitalManagemetProject {
	...
	public static void main(String[] args) {
...

		{
	        ...
	        d[0].did = "21";
	        d[0].dname = "Dr.Meena";
	        d[0].specilist = "Dentist";
	        d[0].age=43;
	        d[0].appoint = "5-10AM";
	        d[0].doc_qual = "MBBS,MD";
	        d[0].droom = 17;
	        d[1].did = "32";
	        d[1].dname = "Dr.Barathi";
	        d[1].specilist = "Neurologist";
	        d[1].age=50;
	        d[1].appoint = "10-3AM";
